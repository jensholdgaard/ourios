...
/// The log-record attribute the RFC 0050 modes read — the generated
/// registry constant (RFC0050.7; a local pre-adopted definition
/// tracking semantic-conventions #1283 / #2064, the name
/// collector-contrib's drainprocessor ships today).
pub const LOG_RECORD_TEMPLATE_ATTR: &str = ourios_semconv::LOG_RECORD_TEMPLATE;
