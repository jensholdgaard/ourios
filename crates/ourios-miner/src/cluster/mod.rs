...
// Scope glue for the split: siblings and the test module reach each
// other's items through this parent scope, so every pre-split path
// resolves unchanged. Wildcards are the point (the children ARE this
// module).
